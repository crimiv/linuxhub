...
- [Giant Simulator](https://www.roblox.com/games/12645083079/Giant-Simulator-REBORN)

### Loadstring

```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/crimiv/bandithub/test/main.lua"))()
```
